...
- stats.ts: export interface Stats; export type StatsResult = Stats; export function getStats(endDate: string, days: number): Stats
...
### Module Dependencies (import graph)
  ...
  lib/stats.ts → imports: lib/date, lib/storage, lib/types, lib/types
  lib/storage.ts → imports: lib/types, lib/types, lib/types
  pages/History.tsx → imports: components/ScreenS...
...
- 0009: computeFortune 오케스트레이션(캐시·근거 가드·저장) (files: src/components/MonthNav.tsx, src/components/SummaryHero.tsx, src/components/Sparkline.tsx, src/components/MiniBar.tsx, src/components/RecentRecordsCard.tsx, src/components/AddRecordCTA.tsx, src/components/AdSlotBanner.tsx)
- 0010: 앱 상태 훅 useAppData + 스트릭 계산 (files: src/pages/RecordNew.tsx, src/pages/RecordEdit.tsx)
...
- 0013: /input 목록·무지출·저장 후 /result 이동 (files: src/pages/Report.tsx, src/pages/ReportUnlockManager.tsx, src/pages/__tests__/Report.test.tsx, src/pages/__tests__/ReportUnlockManager.test.tsx)
